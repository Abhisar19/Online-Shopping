	    			...
	    			<div class="contact-form">
				    	...
				    	<form action="data.php" method="post" enctype="multipart/form-data">
                            <div class="form-group col-md-12">
				                <input type="text" name="pname" id="pname" class="form-control" required="required" placeholder="Product Name">
				            </div>
				            <div class="form-group col-md-12">
				                <input type="text" name="pprice" id="pprice" class="form-control" required="required" placeholder="Product Price">
				            </div>
				            <div class="form-group col-md-12">
				                <input type="text" name="pqty" id="pqty" class="form-control" required="required" placeholder="Product Quantity">
				            </div>
				            <div class="form-group col-md-12">
                            ...
                            <div class="form-group col-md-12">
				             <input type="text" name="pcategory" id="pcategory" class="form-control" required="required" placeholder="Product Category">
				             </div>   	

                            <div class="form-group col-md-12">
				                <input type="text" name="pdesc" id="pdesc" class="form-control" required="required" placeholder="Product Description">
				            </div>
