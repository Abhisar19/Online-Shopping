    		...
    		<div class="row">  	
	    		<div class="col-sm-8">
	    			<div class="contact-form">
				    	...
				    	<form action="data1.php" id="main-contact-form" class="contact-form row" name="contact-form" method="post">
	    		...
	    		<div class="col-sm-4">
	    			<div class="contact-info">
	    				...
	    				<address>
	    					<p>E-Shop</p>
							<p>House no 774, Sector 11, Vasundhara, Ghaziabad</p>
							<p>Mobile: +91 8860357012</p>
							<p>Email: abhisar1906@gmail.com</p>
	    				</address>
