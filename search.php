...
<td><a href="process.php?id=<?php echo $result["id"]; ?>" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
</td>
</tr>
...
</center><footer id="footer"><!--Footer-->
