		...
		<div class="container">
				<div class="col-sm-12">
					...
					<div class="product-information"><!--/product-information-->
                         ...
                         ?> 
                                <center><img src="<?php echo $row["image"]; ?>" alt="" height="220px" width="150px"></center>
                                <br>
                                <br>
                                <h4>Web ID: <?php echo $row["id"]; ?></h4>
                                <h4><b>Price:</b> Rs <?php echo $row["pprice"]; ?></h4>
                                <h4><b>Product Name:</b> <?php echo $row["pname"]; ?></h4>
                                <h4><b>Product Description:</b> <?php echo $row["pdesc"]; ?></h4>
							<br>
							<center>
				     		<a href="process.php?id=<?php echo $row["id"]; ?>" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
							</center>
