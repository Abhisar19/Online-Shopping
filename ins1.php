...
$sql = "INSERT INTO bill (fname, email, address, city, state, pincode) VALUES ('$fname', '$email', '$address', '$city', '$state', '$pincode')";
if(mysqli_query($link, $sql)){
    echo "Successfully Provided Billing Information";
} else{
...
<br>
<center>
<a href="payment1.php">Continue for Payment</a>
 </center>
  </div>
  </section>
